...
enum HomeElementContentCongress: Int {
    ...
    func title() -> String {
        let titles = ["活动提醒", "履职记录", "履职统计", "共享空间", "代表风采", "通知通报", "知情知政", "调查问卷", "建议意见", ""]
        
        return titles[self.rawValue]
    }
    
    func icon() -> String {
        let icons = ["huo_dong_ti_xing", "lv_zhi_ji_lu", "lv_zhi_tong_ji", "gong_xiang_kong_jian", "dai_biao_xin_xi", "tong_zhi_tong_bao", "zhi_qing_zhi_zheng", "diao_cha_wen_juan", "suggestion", ""]
