...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if SettingKey.Launched.value() == nil {
            SettingKey.Launched.setValue(true as AnyObject)
            let storyboard = UIStoryboard(name: "Main", bundle: nil)
            let vc = storyboard.instantiateViewController(withIdentifier: "GuideViewController")
        ...
        JPUSHService.setup(withOption: launchOptions, appKey: "27e7b2832940b328b5e2786f", channel: "AppStore", apsForProduction: false)
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.coolrabbit.PeopleCongressSystem" in the application's documents Application Support directory.
